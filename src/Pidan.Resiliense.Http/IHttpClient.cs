...
namespace Pidan.Resiliense.Http
{
    public interface IHttpClient
    {
        ...
        Task<HttpResponseMessage> PostAsync(string uri, Dictionary<string, string> dictionary,
        ...
        Task<HttpResponseMessage> PutAsync(string uri, Dictionary<string, string> dictionary,
            string authorizationToken = null,
            string requestId = null, string authorizationMethod = "Bearer");
